...
const WORKSHEETS = {
  ...
  potenzfunktionen: {
    ...
    tasks: [
      { nr: "1", frage: "f(x)=x²: a) f(4)  b) f(−2)",
        loesung: "a) 16  b) 4" },
      { nr: "2", frage: "f(x)=x³: a) f(2)  b) f(−2)",
        loesung: "a) 8  b) −8" },
      { nr: "3", frage: "Symmetrie: a) x⁴  b) x³  c) x⁶",
        loesung: "a) achsensymmetrisch  b) punktsymmetrisch  c) achsensymmetrisch" },
      { nr: "4", frage: "Grad bestimmen: a) 2x³+x  b) 5x⁴−x²+7",
        loesung: "a) 3  b) 4" },
      { nr: "5", frage: "⭐ Welche sind punktsymmetrisch: x², x³, x⁴, x⁵?",
        loesung: "x³ und x⁵ (ungerade Exponenten)" },
    ],
  },
  exponentialfunktionen: {
    titel: "Exponentialfunktionen & Wachstum",
    tasks: [
      { nr: "1", frage: "f(x)=2ˣ: a) f(4)  b) f(0)",
        loesung: "a) 16  b) 1" },
      { nr: "2", frage: "Startwert f(0) von f(x)=5·3ˣ",
        loesung: "5 (denn 3⁰ = 1)" },
      { nr: "3", frage: "Wachstumsfaktor b: a) +10 %  b) −25 %",
        loesung: "a) 1,1  b) 0,75" },
      { nr: "4", frage: "Start 200, verdoppelt sich pro Stunde, nach 4 Stunden",
        loesung: "200·2⁴ = 3200" },
      { nr: "5", frage: "1000 € mit 3 % Zinsen, nach 1 Jahr",
        loesung: "1000·1,03 = 1030 €" },
      { nr: "6", frage: "⭐ Welcher Faktor bedeutet Zerfall: 1,2; 0,9; 1,0?",
        loesung: "0,9 (zwischen 0 und 1)" },
    ],
  },
  logarithmen: {
    titel: "Logarithmen",
    tasks: [
      { nr: "1", frage: "a) log₂(8)  b) log₂(32)  c) log₂(64)",
        loesung: "a) 3  b) 5  c) 6" },
      { nr: "2", frage: "a) log₁₀(100)  b) log₁₀(10 000)",
        loesung: "a) 2  b) 4" },
      { nr: "3", frage: "a) log₃(27)  b) log₅(25)",
        loesung: "a) 3  b) 2" },
      { nr: "4", frage: "Löse: a) 2ˣ=16  b) 10ˣ=1000",
        loesung: "a) x=4  b) x=3" },
      { nr: "5", frage: "⭐ a) log₂(1)  b) log₇(7)",
        loesung: "a) 0  b) 1" },
    ],
  },
  sinusfunktion: {
    ...
    tasks: [
      { nr: "1", frage: "a) sin(0°)  b) sin(90°)  c) sin(180°)",
        loesung: "a) 0  b) 1  c) 0" },
      { nr: "2", frage: "a) cos(0°)  b) cos(90°)  c) cos(180°)",
        loesung: "a) 1  b) 0  c) −1" },
      { nr: "3", frage: "Periode der Sinusfunktion",
        loesung: "360°" },
      { nr: "4", frage: "y=4·sin(x): a) Amplitude  b) größter Wert  c) kleinster Wert",
        loesung: "a) 4  b) +4  c) −4" },
      { nr: "5", frage: "⭐ Zwischen welchen Werten schwankt y=2·cos(x)?",
        loesung: "zwischen −2 und +2" },
    ],
  },
  "sinus-kosinus-satz": {
    titel: "Sinus- & Kosinussatz",
    tasks: [
      { nr: "1", frage: "Kosinussatz c² (cos 60°=0,5): a) a=4,b=5,γ=60°  b) a=2,b=3,γ=60°",
        loesung: "a) 41−20 = 21  b) 13−6 = 7" },
      { nr: "2", frage: "Was wird aus dem Kosinussatz bei γ=90°?",
        loesung: "c² = a² + b² (Satz des Pythagoras, da cos 90° = 0)" },
      { nr: "3", frage: "Sinussatz: a=5, α=30°, β=90° → b",
        loesung: "5 · 1 / 0,5 = 10" },
      { nr: "4", frage: "Welcher Satz bei zwei Seiten + eingeschlossenem Winkel?",
        loesung: "der Kosinussatz" },
      { nr: "5", frage: "⭐ Kosinussatz: a=7, b=8, γ=60° → c²",
        loesung: "49+64−56 = 57" },
    ],
  },
  "bedingte-wahrscheinlichkeit": {
    titel: "Bedingte Wahrscheinlichkeit (Vierfeldertafel 200 Schüler: Jungen 60 Bus/40 Rad, Mädchen 80 Bus/20 Rad; Summen: Bus 140, Rad 60)",
    tasks: [
      { nr: "1", frage: "P(Junge)",
        loesung: "100/200 = 0,5" },
      { nr: "2", frage: "P(Bus)",
        loesung: "140/200 = 0,7" },
      { nr: "3", frage: "P(Junge und Bus)",
        loesung: "60/200 = 0,3" },
      { nr: "4", frage: "P(Bus | Junge)",
        loesung: "60/100 = 0,6" },
      { nr: "5", frage: "⭐ P(Junge | Bus)",
        loesung: "60/140 = 3/7 ≈ 0,43" },
    ],
  },
  statistik: {
    titel: "Beschreibende Statistik",
    tasks: [
      { nr: "1", frage: "Mittelwert von 3, 5, 7, 7, 8",
        loesung: "30 ÷ 5 = 6" },
      { nr: "2", frage: "Median von 3, 5, 7, 7, 8",
        loesung: "7 (mittlerer Wert)" },
      { nr: "3", frage: "Modalwert von 3, 5, 7, 7, 8",
        loesung: "7 (häufigster Wert)" },
      { nr: "4", frage: "Spannweite von 3, 5, 7, 7, 8",
        loesung: "8 − 3 = 5" },
      { nr: "5", frage: "⭐ Median von 2, 4, 6, 8",
        loesung: "(4 + 6) ÷ 2 = 5" },
    ],
  },
};
